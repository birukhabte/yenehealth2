    ...
    <div className="max-w-[1860px] mx-auto h-full px-[20px] flex items-center">
      ...
      <div className="flex items-center gap-[22px] shrink-0">
        ...
        <ul className="flex items-center gap-[32px] list-none ml-[16px]">
          {navLinks.map((l) => (
            <li key={l}>
              <a href="#" className="text-[13px] font-medium text-[#f5666d] hover:opacity-80 transition-opacity">
                {l}
              </a>
            </li>
          ))}
      ...
      <div className="ml-[40px] shrink-0 w-[360px] h-[46px] bg-white rounded-[999px] shadow-[0_4px_14px_rgba(0,0,0,0.06)] flex items-center pl-[20px] pr-[6px] gap-[12px]">
        ...
        <button
          type="button"
          aria-label="Search"
          className="ml-[8px] w-[50px] h-[38px] rounded-[999px] bg-[#f5666d] flex items-center justify-center shrink-0 hover:brightness-105 transition"
        >
      ...
      <button
        type="button"
        className="ml-[210px] shrink-0 h-[30px] px-[15px] rounded-[999px] bg-[#f5666d] text-white text-[12px] font-semibold whitespace-nowrap hover:brightness-105 transition"
      >
        For Businesses
      </button>
      ...
      <div className="ml-auto flex items-center gap-[20px] shrink-0">
        <button type="button" className="flex items-center gap-[5px] text-[13px] font-semibold text-[#f5666d]">
          English
        ...
        <a href="#" className="text-[13px] font-semibold text-[#f5666d] whitespace-nowrap">SIGN IN</a>

        <button type="button" aria-label="Wishlist" className="text-[#f5666d]">
        ...
        <button type="button" aria-label="Cart" className="text-[#f5666d]">
          <svg className="w-[20px] h-[20px]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
